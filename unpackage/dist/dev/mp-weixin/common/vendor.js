...
/***/ 16:
/*!*********************************************!*\
  !*** E:/Learn/uniapp/demo01/store/index.js ***!
  \*********************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    addCart: function addCart(state, goodInfo) {
      state.cartGoods = state.cartGoods.concat(goodInfo);
    },
    subGood: function subGood(state, id) {
      state.cartGoods.some(function (item) {
        if (item.goods_id == id)
        {
          item.goods_number--;
        }
    ...
    addGood: function addGood(state, id) {
      state.cartGoods.some(function (item) {
        if (item.goods_id == id)
        {
          item.goods_number++;
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "首页" }, "pages/category/category": { "navigationBarTitleText": "分类" }, "pages/cart/cart": { "navigationBarTitleText": "购物车" }, "pages/mine/mine": { "navigationBarTitleText": "我的" }, "pages/seach/seach": { "navigationBarTitleText": "搜索" }, "pages/detail/detail": { "navigationBarTitleText": "商品详情" } }, "globalStyle": { "navigationBarTextStyle": "white", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#0a7d7d", "backgroundColor": "#FFFFFF" } };exports.default = _default;
